...
namespace {
  ...
  byte DayOfWeek(const PCF8583 &now) {
    ...
    const char PROGMEM MonthTable[24] = {0, 3, 3, 6, 1, 4, 6, 2, 5, 0, 3, 5, (char)-1, 2, 3, 6, 1, 4, 6, 2, 5, 0, 3, 5}; // modified by Anthony Good 2015-03-23 for compilation under Arduino 1.6.1, cast added for STM32 compatibility
