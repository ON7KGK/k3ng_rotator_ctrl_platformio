...
// Serial Port Settings - Nano R4 ANTENNA Unit (Slave)
#define CONTROL_PORT_MAPPED_TO &Serial1    // RS485 slave port (receives commands from SHACK)
#define CONTROL_PORT_BAUD_RATE 9600
//#define REMOTE_PORT Serial3                // Not used on slave unit
#define REMOTE_UNIT_PORT_BAUD_RATE 9600
#define GPS_PORT Serial2                    // GPS receiver on ANTENNA unit
#define GPS_PORT_BAUD_RATE 9600
// #define GPS_MIRROR_PORT Serial           // Mirror GPS to USB Serial for debugging
// #define GPS_MIRROR_PORT_BAUD_RATE 9600
// No display on ANTENNA unit
