...
#define ETHERNET_IP_ADDRESS 192,168,100,100  //<-DON'T FORGET TO USE DIFFERENT IP ADDRESSES FOR MASTER AND SLAVE!!!
...
// Serial Port Settings - Nano R4 SHACK Unit
#define CONTROL_PORT_MAPPED_TO &Serial     // USB Serial for PC control
#define CONTROL_PORT_BAUD_RATE 9600
#define REMOTE_PORT Serial1                 // RS485 to ANTENNA unit via Serial1 (D0/D1)
#define REMOTE_UNIT_PORT_BAUD_RATE 9600
// GPS is on ANTENNA unit, data synced via RS485
...
// Nextion Display uses Serial1 which conflicts with RS485
// User must choose between Nextion OR RS485, or use SoftwareSerial for one of them
//#define nexSerial Serial1                 // Disabled - conflicts with RS485
