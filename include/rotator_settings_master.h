/* ---------------------- ANTENNA Unit (Master) - Settings Configuration ----------------------
 *
 * This file defines settings for the ANTENNA Unit (Master)
 ...
 * - GPS_PORT = Serial2 (GPS on A4/A5)
 * - Ethernet MAC/IP addresses specific to Master unit
 */
...
/* ========== MASTER UNIT SPECIFIC SETTINGS ========== */

// Ethernet configuration for MASTER unit (Antenna)
#define ETHERNET_MAC_ADDRESS 0xDE,0xAD,0xBE,0xEF,0xAA,0x01  // MASTER MAC - Different from Remote!
#define ETHERNET_IP_ADDRESS 192,168,100,101                  // MASTER IP - Different from Remote!
...
/* ========== SERIAL PORT SETTINGS - MASTER SPECIFIC ========== */
// IMPORTANT: Master uses Serial1 for RS485 communication with Remote unit
#define CONTROL_PORT_MAPPED_TO &Serial1    // RS485 on Serial1 (D0/D1 TX/RX)
#define CONTROL_PORT_BAUD_RATE 9600

// GPS on Serial2 (hardware UART on A4/A5)
...
// Nextion display not used on Master (used on Remote instead)
